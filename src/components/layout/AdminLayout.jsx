...
import { LayoutDashboard, Box, Heart, Users, LogOut, Home, Truck, User, Bookmark } from 'lucide-react';
...
const AdminLayout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { label: 'Biens', icon: Box, path: '/admin/products' },
    { label: 'Réservations', icon: Bookmark, path: '/admin/orders' },
    { label: 'Agents', icon: Users, path: '/admin/deliverers' },
