...
const DELIVERY_ZONES = {
  'Douala': { 'Akwa': 2000, 'Bonapriso': 2500, 'Kotto': 3500, 'Logpom': 4000 },
  'Yaoundé': { 'Bastos': 3000, 'Mvan': 3500, 'Olembe': 5000 },
  'Kribi': { 'Centre': 2000, 'Bord de mer': 3000 }
};
  ...
  if (cart.length === 0 && !isSuccess) {
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        <h1 className="text-2xl font-bold mb-4">Votre sélection est vide</h1>
              ...
              <div className="space-y-3">
                ...
                <label className={`flex items-center p-4 border rounded-lg cursor-pointer hover:bg-orange-50 transition-colors ${paymentMethod === 'om' ? 'border-orange-500 bg-orange-50/50' : 'border-slate-200'}`}>
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-xs text-secondary">Paiement sécurisé via Orange Money Côte d'Ivoire</p>
                  </div>
                </label>
