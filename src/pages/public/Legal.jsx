    ...
    <div className="container mx-auto px-4 py-16 max-w-3xl">
      ...
      <div className="prose prose-slate max-w-none space-y-6 text-secondary">
        <section>
          ...
          <p>
            Les présentes conditions régissent les ventes réalisées par l'entreprise ABI IMMOBILIER via son site web. 
            Toute commande implique l'adhésion entière et sans réserve du client.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-bold text-secondary-dark mb-3">2. Biens et Prix</h2>
          <p>
            Les biens proposés sont ceux figurant sur le catalogue. Les prix sont exprimés en Francs CFA (F CFA) 
