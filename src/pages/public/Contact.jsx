          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://wa.me/237658204821" target="_blank" rel="noopener noreferrer" className="mt-2 inline-flex items-center text-xs bg-green-500 text-white px-3 py-1 rounded-full hover:bg-green-600 transition-colors"><MessageCircle className="w-3 h-3 mr-1" /> WhatsApp</a>
