import { TrendingUp, Bookmark, Users, DollarSign, Heart } from 'lucide-react';

const AdminDashboard = () => {
  const stats = [
    { label: 'Valeur du catalogue', value: '4 520 000 F CFA', icon: DollarSign, color: 'bg-green-500' },
    { label: 'Réservations', value: '24', icon: Bookmark, color: 'bg-blue-500' },
    { label: 'Prospects', value: '12', icon: Users, color: 'bg-purple-500' },
